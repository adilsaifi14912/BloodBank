...
<body>
<div class="container">
    <h1>Agent Created Users</h1>
        <button type="button" class="btn btn-primary mt-5 fr"><a href="/agent" class="btn blue pad">Back</a></button>
    ...
    <div class="dropdown-container">
        <div class="dropdown show">
            ...
            <div class="dropdown-menu" aria-labelledby="sortByDropdown">
                <a class="dropdown-item" href="/agentSort/nameAsc">Name-Asc</a>
                <a class="dropdown-item" href="/agentSort/createdByAsc">CreatedBy-Asc</a>
                <a class="dropdown-item" href="/agentSort/bloodGroupAsc">Blood Group-Asc</a>
                <a class="dropdown-item" href="/agentSort/nameDesc">Name-Desc</a>
                <a class="dropdown-item" href="/agentSort/createdByDesc">CreatedBy-Desc</a>
                <a class="dropdown-item" href="/agentSort/bloodGroupDesc">Blood Group-Desc</a>
            </div>
        </div>
    </div>
  <form>
    <div class="dropdown-container">
        <div class="dropdown show">
            ...
            <div class="dropdown-menu" aria-labelledby="otherDropdown">
                ...
                <a class="dropdown-item" href="#" onclick="applyFilter('loggedInUsers')">Not Logged In Users</a>
            </div>
    ...
    <table>
        ...
        <tbody>
            <% if (request.getAttribute("sortedUsers") == null) {
                List<SignupDTO> allUsers = (List<SignupDTO>) session.getAttribute("agentCreatedUsers");
            ...
            <% }
                ...
                List<SignupDTO> allUsers = (List<SignupDTO>) request.getAttribute("sortedUsers");
                for (SignupDTO endUser : allUsers) { %>
                    <tr>
                        <td><%= endUser.getUsername() %></td>
                        <td><%= endUser.getDateOfBirth() %></td>
...
<script>
    function applyFilter(filterOption) {
        var filterValue = "";
        if (filterOption === 'name' || filterOption === 'date') {
        ...
        var url = "/agentFilter/" + filterOption + "?filterValue=" + encodeURIComponent(filterValue);
