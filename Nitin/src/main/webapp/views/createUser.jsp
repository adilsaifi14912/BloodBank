...
<head>
    ...
    <style>
        ...
        .create-user-form input[type="tel"],
        .create-user-form select { /* Added select element */
            width: 100%;
            padding: 10px;
            margin-bottom: 10px;
...
<button type="button" class="btn btn-primary mt-5 fr" style="background-color: #007bff; color: #fff; border: none; border-radius: 5px; padding: 10px 20px;">
    <a href="/agent" class="btn blue pad" style="text-decoration: none; color: #fff;">Back</a>
</button>

<div class="container">
    <h2>Create User</h2>
    <form class="create-user-form" action="userSignup" method="post">
